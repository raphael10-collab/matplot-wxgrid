...
wxBEGIN_EVENT_TABLE( GridFrame, wxFrame )
    ...
    EVT_MENU( ID_PARETO, GridFrame::Pareto)
                   ...
                   wxDefaultSize )
{
    ...
    selectMenu->Append( ID_PARETO, "Pareto");
...
void GridFrame::Pareto(wxCommandEvent& WXUNUSED(event))
{
    std::vector<double> paretoInput = {90, 75, 30, 60, 5, 40, 40, 5};
    pareto(paretoInput);
    show();
}
